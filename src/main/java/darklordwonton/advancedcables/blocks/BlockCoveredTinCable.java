...
public class BlockCoveredTinCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockCoveredTinCable(Material materialIn) {
		super(materialIn);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
		...
		tileEntity.init(EnumCableType.TIN, true);
