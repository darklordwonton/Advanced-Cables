...
public class BlockSuperCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockSuperCable(Material materialIn) {
		super(materialIn);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
		...
		tileEntity.init(EnumCableType.SUPER, false);
