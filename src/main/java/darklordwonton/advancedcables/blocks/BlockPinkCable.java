...
public class BlockPinkCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockPinkCable(Material materialIn) {
		super(materialIn);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
		...
		tileEntity.init(EnumCableType.PINK, false);
