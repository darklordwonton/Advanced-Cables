...
public class BlockCoveredPinkCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockCoveredPinkCable(Material materialIn) {
		super(materialIn);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
		...
		tileEntity.init(EnumCableType.PINK, true);
