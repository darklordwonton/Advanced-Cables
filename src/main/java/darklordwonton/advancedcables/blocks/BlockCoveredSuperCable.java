...
public class BlockCoveredSuperCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockCoveredSuperCable(Material materialIn) {
		super(materialIn);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
		...
		tileEntity.init(EnumCableType.SUPER, true);
