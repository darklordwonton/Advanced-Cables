...
public class BlockCoveredGoldCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockCoveredGoldCable(Material materialIn) {
		super(materialIn);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
		...
		tileEntity.init(EnumCableType.GOLD, true);
