...
public class BlockCoveredEnderCable extends BaseCableBlock implements ITileEntityProvider {

	public BlockCoveredEnderCable(Material materialIn) {
		super(materialIn);
